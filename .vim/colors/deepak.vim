...
hi ErrorMsg        guifg=#80d4aa guibg=#ffffff gui=bold
...
if &t_Co > 255
    ...
    hi DiffAdd         ctermfg=255   ctermbg=241     cterm=bold
    hi DiffChange      ctermfg=0     ctermbg=137  
    hi DiffDelete      ctermfg=236   ctermbg=66
    ...
    hi IncSearch       ctermbg=0     ctermfg=215    
    ...
    hi Search          ctermfg=0     ctermbg=250    
    ...
    hi MatchParen      ctermfg=16   ctermbg=70     cterm=bold
    ...
    " pmenu
    hi PMenu      ctermfg=251  ctermbg=238
...
if exists("g:zenburn_alternate_Error")
    ...
    hi Error           guifg=#ef9f9f guibg=#ffffff gui=bold  
else
    " default
    hi Error           guifg=#e37170 guibg=#ffffff gui=bold
endif
