...
if &t_Co > 255
    ...
    hi DiffAdd         ctermfg=255   ctermbg=237     cterm=bold
    ...
    hi MatchParen      ctermfg=16    ctermbg=174     cterm=bold
    ...
    if exists("g:zenburn_high_Contrast") && g:zenburn_high_Contrast
       ...
       " hi Normal ctermfg=21 ctermbg=237
...
if exists("g:zenburn_old_Visual") && g:zenburn_old_Visual
    if exists("g:zenburn_alternate_Visual") && g:zenburn_alternate_Visual
        ...
        " use default visual
        hi Visual          guifg=#233323 guibg=#ffffff gui=none
